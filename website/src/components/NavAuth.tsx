    ...
    return (
      <div className={cn("inline-flex items-center gap-2", className)}>
        {user.isAdmin && (
          <Link
            href="/admin"
            className="hidden items-center gap-1.5 rounded-2xl border border-white/12 bg-white/[0.06] px-3 py-1.5 text-sm text-neutral-200 transition-colors hover:border-white/25 hover:text-white sm:inline-flex"
        ...
        <Link
          href="/account"
          className="inline-flex items-center gap-2 rounded-2xl border border-white/12 bg-white/[0.06] py-1 pl-1 pr-3 text-sm text-neutral-200 transition-colors hover:border-white/25 hover:text-white"
          title="Your account"
        >
          {user.image ? (
