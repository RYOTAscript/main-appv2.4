...
export const SITE = {
  ...
  author: "ryota",
  description:
    "An always-on glass-morphism Windows overlay for gaming and power users — Spotify with synced lyrics, live performance, one-click FPS tweaks, quick launch, and 19 mini widgets. One-time $5 lifetime license.",
} as const;

/** Prefixed "v" label, e.g. "v3.47.1". */
